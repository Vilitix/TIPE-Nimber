...
let random_strat table =
  ...
  while not(is_playable table !i !j tab_direction.(!k)) do
          begin
            i := Random.int n;
            j := Random.int p;
            k := Random.int 4;
